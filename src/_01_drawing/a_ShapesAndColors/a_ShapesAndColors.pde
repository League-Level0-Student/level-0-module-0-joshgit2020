...
ellipse(350,540, 220,220);
fill(#000000);
rect(250,280, 200,30); 
rect(285,170, 130,120);
ellipse(330,340, 13,13);
ellipse(370,340, 13,13);
ellipse(350,480, 13,13);
ellipse(350,540, 13,13);
ellipse(350,600, 13,13);
fill(#FA8B03);
triangle(340,350, 360,350, 350,370);
